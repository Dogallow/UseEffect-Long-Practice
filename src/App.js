...
function App() {
  ...
  useEffect(()=> {
    ...
    if(isRed) arr.push('red');
    if(isOrange) arr.push('orange');
    if(isBrown) arr.push('brown');
    if(isLightBrown) arr.push('light-brown');
    if(isYellow) arr.push('yellow');

    setFeatherColors(arr);
